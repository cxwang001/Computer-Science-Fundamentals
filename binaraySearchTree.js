...
BinarySearchTree.prototype.insert = function(value){
  ...
  if (this.head === null){
    ...
    // when stuff has already been inserted - function for find and insert
...
BinarySearchTree.prototype.delete = function(deleteValue){
  ...
  //if the new arrat holding all the nodes are the same size as the original Bi Tree then it was not found all values were pushed in
